      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-950/60">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1.5 text-slate-400 hover:text-white hover:bg-slate-800 rounded-lg transition-colors cursor-pointer"
            title="Đóng (Esc)"
          >
        ...
        <div className="p-6 space-y-4">
          ...
          {currentUser ? (
            ...
            <>
              ...
              {/* Tab Content Wrapper with fixed min-height to prevent jumping between tabs */}
              <div className="min-h-[390px] flex flex-col justify-between">
                {/* TAB: TẠO TÀI KHOẢN (ĐƠN GIẢN & NGẮN GỌN) */}
                {activeTab === 'register' && (
                  <form onSubmit={handleSimpleRegister} className="flex-1 flex flex-col justify-between pt-1 animate-fadeIn">
                ...
                {/* TAB: ĐĂNG NHẬP */}
                {activeTab === 'login' && (
                  <form onSubmit={handleQuickLogin} className="flex-1 flex flex-col justify-between pt-1 animate-fadeIn">
                    <div className="space-y-3.5">
                      ...
                      <div className="p-3.5 rounded-xl bg-slate-950/50 border border-slate-800 text-[11px] text-slate-400 flex items-start gap-2.5">
                        <Sparkles className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                        <div className="leading-relaxed">
                          Đăng nhập để tích lũy <span className="text-amber-300 font-semibold">Tu Vi</span>, mở khóa <span className="text-amber-300 font-semibold">Linh Đài</span> và bảo lưu danh hiệu trên <span className="text-amber-300 font-semibold">Bảng Vàng</span>.
                        </div>
                      </div>
                    </div>
