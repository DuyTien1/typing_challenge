...
export const OnlineUsersModal: React.FC<OnlineUsersModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-4xl max-h-[90vh] bg-[#121622] border border-slate-700/80 rounded-2xl shadow-2xl flex flex-col overflow-hidden text-slate-200"
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-800/80 bg-slate-900/90 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="Đóng cửa sổ"
              className="p-2 rounded-lg bg-slate-800/60 hover:bg-rose-950/60 hover:border-rose-500/40 text-slate-400 hover:text-rose-300 border border-slate-700 transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
              ...
              <div className="p-4 rounded-xl bg-slate-850/70 border border-slate-800">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="p-3 rounded-lg bg-slate-900/80 border border-slate-800 text-center">
                    <span className="text-[11px] text-slate-400 block mb-1">Kỷ Lục Tốc Độ</span>
                    <span className="text-xl font-black text-amber-400">
                      {selectedUser.bestWpm || 0} <span className="text-xs font-normal text-slate-400">WPM</span>
                    </span>
                  </div>
