  ...
  if (!isLoggedIn) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
        <div className="relative w-full max-w-md bg-slate-900 border border-amber-500/40 rounded-3xl p-6 shadow-2xl text-center">
          <button
            onClick={() => {
              soundFx.playKeyClick();
              onClose();
          ...
          <h2 className="text-lg font-black text-amber-300 uppercase tracking-wider mb-1">
            Linh Đài Tu Tiên
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-2.5">
            <button
              ...
              className="flex-1 py-2.5 px-4 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 hover:from-amber-400 hover:to-yellow-300 text-slate-950 font-black text-xs uppercase tracking-wider shadow-lg shadow-amber-500/20 transition-all active:scale-95 cursor-pointer"
            >
              Đăng Nhập / Đăng Ký
            </button>
            <button
              ...
              className="py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold text-xs transition-all active:scale-95 cursor-pointer"
            >
              Để Sau
            </button>
          </div>
        ...
        <div className={`relative shrink-0 px-6 py-5 bg-gradient-to-r ${currentRealm.bgGradient} border-b border-amber-500/30 flex items-center justify-between`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800/80 transition-colors cursor-pointer"
              title="Đóng (Esc)"
            >
